        ...
        <div class="flex items-center">
          <div class="w-full">
            <input
              type="search"
              name="q_word"
              class="w-full px-4 py-1 text-gray-800 focus:outline-none rounded-l-lg"
              placeholder="ブックを検索"
              x-model="search"
            />
          </div>
          <div>
            <button
              type="submit"
              class="flex items-center bg-white justify-center w-8 h-8 text-gray-800 rounded-r-lg"
